...
type svcCollector24hr struct {
	svcTargets []svcTarget
}

type yml_con24hr struct {
	Monitor struct {
...
func (c *conf24hr) getConf() *conf24hr {
...
func readConfig24hr(configFile *string) *svcCollector24hr{
	fmt.Println("*****readConfig24hr")
...
func newSvcCollector24hr(c *svcCollector24hr) *svcCollector24hr {

	fmt.Println("*****newSvcCollector24hr")
...
func (c *svcCollector24hr) Describe(ch chan<- *prometheus.Desc) {
...
func (c *svcCollector24hr) Collect(ch chan<- prometheus.Metric) {
