...
type svcCollector1hr struct {
	svcTargets []svcTarget
}

type yml_conf1hr struct {
	Monitor struct {
...
func (c *conf1hr) getConf() *conf1hr {
...
func readConfig1hr(configFile *string) *svcCollector1hr {
	fmt.Println("*****readConfig1hr")
...
func newSvcCollector1hr(c *svcCollector1hr) *svcCollector1hr {

	fmt.Println("*****newSvcCollector1hr")
...
func (c *svcCollector1hr) Describe(ch chan<- *prometheus.Desc) {
...
func (c *svcCollector1hr) Collect(ch chan<- prometheus.Metric) {
